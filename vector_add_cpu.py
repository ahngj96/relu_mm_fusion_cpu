...
######################################################################
my_vector_add = load_library.load_op_library('./custom_op/vector_add.so')
scalar = tf.constant( value=[1] , dtype="float", shape=[1,1] )


output = my_vector_add.tensor_vector_add( t1, scalar )
